...
% X is the raw data matrix is size n x p:
...
% the algorithm demeans the data by default, and adjusts 
...
% has already been demeaned. No further demeaning takes place,
% but the effective sample is reduced by one.
